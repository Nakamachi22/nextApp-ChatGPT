  ...
  <div className='h-screen flex flex-col items-center justify-center'>
    ...
    >
        ...
        <div className='flex justify-end'>
            <button type='submit' className='bg-blue-400 text-white font-bold my-2 py-2 px-4 rounded hover:bg-blue-500'>ログイン</button>
        </div>
        <div className='mt-4'>
            <span className='text-gray-600 text-sm'>初めてのご利用の方はこちらから</span><br/>
